...
@admin.register(MakeAPayment)
class PaymentAdmin(admin.ModelAdmin):
    list_display = ['entranceFee', 'dateOfPayment', 'paymentMethod', 'document']


@admin.register(VerificationOfDocuments)
class VerificationOfDocuments(admin.ModelAdmin):
    list_display = ['documentVrf','applicationForMembership', 'passportSides', 'addressReference']    